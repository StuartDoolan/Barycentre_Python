...
tGPS = [187687688, 276576576, 3765765, 4858758768]  
...
##### perform Earth barycentring - be more specific with import 
from barycentre_earth import * 


for i in range(length):
    # split time into seconds and nanoseconds
    tts = floor(tGPS[i]);
    ttns = np.multiply((tGPS[i]-tts),1e9) # typo in original matlab script?? 
...
##very clunky, need to run get then barycentre then get again as barycentre 
##takes data from this script, could include full barycentre script here? 
